package com.epam.rd.model.search;

import com.epam.rd.payload.request.FilterRequest;
import com.epam.rd.payload.request.SearchRequest;
import com.epam.rd.payload.request.SortRequest;
...
public class SearchSpecification<T> implements Specification<T> {
    ...
    @Serial
    private static final long serialVersionUID = 566555343320750644L;
